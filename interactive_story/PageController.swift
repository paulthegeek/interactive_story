...
//  interactive_story
//
//  Created by Paul Jackson on 8/12/16.
        ...
        if let page = page {
            ...
            if let firstChoice = page.firstChoice {
                ...
                firstChoiceButton.addTarget(
                    self,
                    action: #selector(PageController.loadFirstChoice),
                ...
                firstChoiceButton.addTarget(
                    self,
                    action: #selector(PageController.playAgain),
                    forControlEvents: .TouchUpInside
                )
            }
            ...
            if let secondChoice = page.secondChoice {
                ...
                secondChoiceButton.addTarget(
                    self,
                    action: #selector(PageController.loadSecondChoice),
                    forControlEvents: .TouchUpInside
                )
            }
        }
